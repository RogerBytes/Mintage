...
- Tester Addon Manager dans floorp, pour vérifier si les politiques d'entreprises (req pour permissions) sont bien prises en compte et que l'extension fonctionne.
